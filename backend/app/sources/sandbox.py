...
class SandboxJobSource(JobSource):
    ...
    async def fetch_raw(self, params: JobSearchParams) -> List[Dict[str, Any]]:
        ...
        sample_jobs = [
            {
                "job_id": "sbx-001",
                "title": "Senior AI Engineer / LLM Systems",
                "company": "NeuralFlow AI",
                "location": "Remote",
                "apply_url": "https://example.com/careers/sbx-001",
                "skills": ["python", "ai", "llm", "pytorch", "langchain", "fastapi"],
                "salary_min": 175000,
                "salary_max": 235000,
                "description": "Build high-throughput LLM evaluation pipelines, agentic orchestration, and resilient inference APIs.",
                "days_ago": 1
            },
            {
                "job_id": "sbx-002",
            ...
            },
            {
                ...
                "skills": ["python", "machine learning", "ai", "pytorch", "docker"],
                "salary_min": 170000,
                "salary_max": 220000,
                "description": "Deploy reliable inference pipelines, fine-tuned transformer models, and schema validation layers.",
                "days_ago": 3
            },
            {
                "job_id": "sbx-005",
            ...
            },
            {
                ...
                "company": "MeshConnect",
                "location": "Remote",
                "apply_url": "https://example.com/careers/sbx-006",
